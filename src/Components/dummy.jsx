...
const OurProducts = () => {
  ...
  const handlePriceFilter = (filterType) => {
    ...
    if (filterType === "ascending") {
      sortedData.sort((a, b) => {
        ...
        const price1 = parseInt(a.txtVal.originalPrice)|| 0;
        const price2 = parseInt(b.txtVal.originalPrice) || 0;
  ...
  const handleDiscountFilter = (filterType) => {
    ...
    if (filterType === "discount-ascending") {
      sortedData.sort((a, b) => {
        const price1 = parseInt(a.txtVal.discountPrice)||0;
        const price2 = parseInt(b.txtVal.discountPrice)||0;
        return price1 - price2;
      });
