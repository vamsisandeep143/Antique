...
import { CartesianGrid, Legend, Line, LineChart, ResponsiveContainer, XAxis, YAxis, Tooltip, PieChart, Pie } from 'recharts';
...
<PieChart width={730} height={250}>
  ...
  <Pie data={data02} dataKey="value" nameKey="name" cx="50%" cy="50%" innerRadius={60} outerRadius={80} fill="#82ca9d" label />
            ...
            <div>
                ...
                <button className='btn btn-secondary' onClick={navigateToGallery}>Gallery</button>
            </div>
            <div className='pic'>
